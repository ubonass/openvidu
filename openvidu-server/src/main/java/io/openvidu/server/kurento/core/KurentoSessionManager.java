...
public class KurentoSessionManager extends SessionManager {
    ...
    public void call(Participant participant, String calleeId, MediaOptions mediaOptions, Integer transactionId) {
        ...
        String sdpAnswer = createAndProcessCallMediaStream(participant,mediaOptions,false);
        if (sdpAnswer != null) {
    ...
    public void onCallAccept(Participant participant, String callerId, MediaOptions mediaOptions, Integer transactionId) {
         ...
         * 将caller和call进行连接
         */
        KurentoParticipant calleeParticipant = (KurentoParticipant) participant;
        KurentoSession kSession = calleeParticipant.getSession();
        ...
        for (Participant p : participants) {
            if (p.getParticipantPublicId().equals(callerId) ||
                p.getParticipantPrivateId()
                        .equals(calleeParticipant.getParticipantPrivateId())) {
                caller = p;
                break;
            }
        }
        ...
        if (caller != null) {
            KurentoParticipant callerParticipant =
                    (KurentoParticipant)
                            kSession.getParticipantByPrivateId(caller.getParticipantPrivateId());
    ...
    public KurentoMediaOptions generateMediaOptions(Request<JsonObject> request) throws OpenViduException {
        ...
        /**
         * modify by jeffrey for defalut is false
         */
