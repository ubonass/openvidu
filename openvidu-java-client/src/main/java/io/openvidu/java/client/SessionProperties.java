...
public class SessionProperties {
    ...
    private SessionType sessionType;//add by jeffrey for sessionType

    /**
     * Builder for {@link io.openvidu.java.client.SessionProperties}
     */
    public static class Builder {
        private SessionType sessionType = SessionType.CALL;//add by jeffrey for sessionType
         ...
         * configured
         * modify by jeffrey for sessionType
         */
        public SessionProperties build() {
            ...
            return new SessionProperties(
                    this.sessionType,this.mediaMode,
                    this.recordingMode, this.defaultOutputMode,
                    this.defaultRecordingLayout, this.defaultCustomLayout,
                    this.customSessionId);
        }

        /**
         * add by jeffrey for sessionType
         * 构建sessionType
         * @param sessionType
         * @return
         */
        public SessionProperties.Builder sessionType(SessionType sessionType) {
    ...
    protected SessionProperties() {
        ...
        this.customSessionId = "";
        this.sessionType = SessionType.CALL;//add by jeffrey for session type
    }
     ...
     * @param outputMode
     * @param layout
     * @param defaultCustomLayout
     * @param customSessionId
     */
    private SessionProperties(SessionType sessionType,
                              MediaMode mediaMode, RecordingMode recordingMode, OutputMode outputMode,
                              RecordingLayout layout, String defaultCustomLayout, String customSessionId) {
        this.mediaMode = mediaMode;
        this.recordingMode = recordingMode;
        this.defaultOutputMode = outputMode;
        ...
        this.defaultCustomLayout = defaultCustomLayout;
        this.customSessionId = customSessionId;
        this.sessionType = sessionType;//add by jeffrey for session type
    }
